...
<jsp:include page="header.jsp">
    ...
    <body>
        ...
        <div name="jstl">
            ...
            <fmt:setLocale value="en_US" variant="FR"/>
            <fmt:setBundle basename="_50_Internalisation.i18n.index" var="fr_FR"/>
            <fmt:setLocale value="en_EN" variant="EN"/>
            <fmt:setBundle basename="_50_Internalisation.i18n.index" var="en_EN"/>
            <fmt:message bundle="${fr_FR}" key="bonjour"/>
